...
def am():
    ...
    while True:
        ...
        if tempProm <= 100 and humProm <= 100:
            ...
            postdata = {"DeviceId":100,"Value":"TEMP","Data":tempProm1,"BusinessUnitId":464,"GreenHouseID":1171,"Time":fecha + " " + hora,"Sensor":lumi}
            print(postdata)
            ...
            postdata1 = {"DeviceId":100,"Value":"RHUM","Data":humProm1,"BusinessUnitId":464,"GreenHouseID":1171,"Time":fecha + " " + hora,"Sensor":"AM2315"}
            print(postdata1)
            ...
            archivo.write(fecha + "," + hora + "," + str(tempProm1) + "," + str(humProm1) + "\n")
            archivo.close()
            print ("OK !")
